...
# python experiments/CIFAR10/Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex FedGMR -num_clients 10 -sample_client high   -patience 10 -bp
# python experiments/CIFAR10/Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex FedGMR -num_clients 10 -sample_client medium -patience 25 -bp
# python experiments/CIFAR10/Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex FedGMR -num_clients 10 -sample_client low    -patience 1  -bp
# python experiments/CIFAR10/Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex FedGMR -num_clients 10 -sample_client high   -patience 15 -niid -bp
# python experiments/CIFAR10/Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex FedGMR -num_clients 10 -sample_client medium -patience 30 -niid -bp
# python experiments/CIFAR10/Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex FedGMR -num_clients 10 -sample_client low    -patience 1  -niid -bp

# ========================= Ablation =========================
# Keep the same patience as the matched `FedGMR` run.
# Main ablation variants: `wo_gmr`, `wo_asyn`, `mask_fed_avg`, `re_mask_fed_avg`, `gradient_avg`, `re_gradient_avg`.

# IID high
# python experiments/CIFAR10/Ablation_Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex wo_gmr             -num_clients 10 -sample_client high   -patience 10 -bp
# python experiments/CIFAR10/Ablation_Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex wo_asyn            -num_clients 10 -sample_client high   -patience 10 -bp
...
# IID medium
# python experiments/CIFAR10/Ablation_Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex wo_gmr             -num_clients 10 -sample_client medium -patience 25 -bp
# python experiments/CIFAR10/Ablation_Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex wo_asyn            -num_clients 10 -sample_client medium -patience 25 -bp
...
# IID low
# python experiments/CIFAR10/Ablation_Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex wo_gmr             -num_clients 10 -sample_client low    -patience 1 -bp
# python experiments/CIFAR10/Ablation_Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex wo_asyn            -num_clients 10 -sample_client low    -patience 1 -bp
...
# Non-IID high
# python experiments/CIFAR10/Ablation_Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex wo_gmr             -num_clients 10 -sample_client high   -patience 15 -niid -bp
# python experiments/CIFAR10/Ablation_Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex wo_asyn            -num_clients 10 -sample_client high   -patience 15 -niid -bp
...
# Non-IID medium
# python experiments/CIFAR10/Ablation_Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex wo_gmr             -num_clients 10 -sample_client medium -patience 30 -niid -bp
# python experiments/CIFAR10/Ablation_Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex wo_asyn            -num_clients 10 -sample_client medium -patience 30 -niid -bp
...
# Non-IID low
# python experiments/CIFAR10/Ablation_Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex wo_gmr             -num_clients 10 -sample_client low    -patience 1 -niid -bp
# python experiments/CIFAR10/Ablation_Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex wo_asyn            -num_clients 10 -sample_client low    -patience 1 -niid -bp
