...
# python experiments/FEMNIST/Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex FedGMR -num_clients 10 -sample_client high   -patience 5 -bp
# python experiments/FEMNIST/Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex FedGMR -num_clients 10 -sample_client medium -patience 4 -bp
# python experiments/FEMNIST/Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex FedGMR -num_clients 10 -sample_client low    -patience 3 -bp
# python experiments/FEMNIST/Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex FedGMR -num_clients 10 -sample_client high   -patience 7 -niid -bp
# python experiments/FEMNIST/Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex FedGMR -num_clients 10 -sample_client medium -patience 3 -niid -bp
# python experiments/FEMNIST/Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex FedGMR -num_clients 10 -sample_client low    -patience 1 -niid -bp

# ========================= Ablation =========================
# Keep the same patience as the matched `FedGMR` run.

# IID high
# python experiments/FEMNIST/Ablation_Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex wo_gmr             -num_clients 10 -sample_client high   -patience 5 -bp
# python experiments/FEMNIST/Ablation_Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex wo_asyn            -num_clients 10 -sample_client high   -patience 5 -bp
...
# IID medium
# python experiments/FEMNIST/Ablation_Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex wo_gmr             -num_clients 10 -sample_client medium -patience 4 -bp
# python experiments/FEMNIST/Ablation_Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex wo_asyn            -num_clients 10 -sample_client medium -patience 4 -bp
...
# IID low
# python experiments/FEMNIST/Ablation_Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex wo_gmr             -num_clients 10 -sample_client low    -patience 3 -bp
# python experiments/FEMNIST/Ablation_Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex wo_asyn            -num_clients 10 -sample_client low    -patience 3 -bp
...
# Non-IID high
# python experiments/FEMNIST/Ablation_Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex wo_gmr             -num_clients 10 -sample_client high   -patience 7 -niid -bp
...
# Non-IID medium
# python experiments/FEMNIST/Ablation_Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex wo_gmr             -num_clients 10 -sample_client medium -patience 3 -niid -bp
# python experiments/FEMNIST/Ablation_Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex wo_asyn            -num_clients 10 -sample_client medium -patience 3 -niid -bp
...
# Non-IID low
# python experiments/FEMNIST/Ablation_Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex wo_gmr             -num_clients 10 -sample_client low    -patience 1 -niid -bp
# python experiments/FEMNIST/Ablation_Prune_increase_FL_CMD.py -i 25 -ic 2.0 -ex wo_asyn            -num_clients 10 -sample_client low    -patience 1 -niid -bp
