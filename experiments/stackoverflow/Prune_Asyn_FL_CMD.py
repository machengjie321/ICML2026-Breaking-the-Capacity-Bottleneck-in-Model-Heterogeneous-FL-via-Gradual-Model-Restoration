...
class args:
    def __init__(self, parse_args):
        ...
        self.resume = False
        self.number_clients = 10
        self.sample_client = 'high'
        self.sample_data_degree = 0.6
        ...
        self.experiment_name =  ('2'+self.sample+'_'+(self.sample_client+'_')+('' if self.sample_data_degree == 0.6 else '_'+str(self.sample_data_degree)) +('_'+str(self.number_clients))+'_'+self.ex+'_'+self.experiment_name +'_'+str(self.patience)+ '_' + str(self.density) + \
...
if __name__ == "__main__":
    os.chdir('/home/mcj/chengjie/PR-FL/')
    ...
    server = FEMNISTFedMapServer(config, args, Conv2(), seed, Adam, {"lr": config.INIT_LR}, use_adaptive, device)
