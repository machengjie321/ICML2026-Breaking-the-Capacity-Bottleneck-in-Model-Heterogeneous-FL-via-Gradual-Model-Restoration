import os
import torch
from bases.fl.simulation_real.Prune_increse_FL import FedMapServer, FedMapClient,FedMapFL, parse_args
...
class args:
    def __init__(self, ):
        self.seed = 0
        self.experiment_name = 'PASL_CIFAR10'
        ...
        self.accumulate = 'g'
        self.patience = 5
        self.average_download_speed = [20]*10
        self.average_upload_speed = [5]*10
