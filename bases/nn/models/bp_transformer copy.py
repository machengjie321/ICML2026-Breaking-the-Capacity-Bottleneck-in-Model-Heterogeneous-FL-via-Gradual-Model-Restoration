...
from bases.nn.embedding import MaskedEmbedding as DenseEmbedding
...
class PositionalEmbedding(nn.Module):
    def __init__(self, embedding_size):
        super().__init__()
        self.positional_embedding = DenseEmbedding(64, embedding_size)
...
class Decoder(nn.Module):
    def __init__(self, num_tokens, embedding_size, rate):
        ...
        self.activation = nn.GELU()
        self.norm1 = nn.LayerNorm(embedding_size)
        self.linear2 = DenseLinear(embedding_size, num_tokens)
